...
const en = {
  ...
  classroom: {
    ...
    regenerateAudiobook: "Regenerate audiobook",
    generatingAudiobook: "Reading article aloud…",
    audiobookStale: "The article text has changed since this audiobook was generated — regenerate to catch up.",
    audioPartOf: "Part {n} of {total}",
    audioPrev: "Prev",
    audioNext: "Next",
    playArticleAudio: "Play article aloud",
    pauseAudio: "Pause",
    paragraphOf: "Paragraph {n} of {total}",
    clickHint: "Click a highlighted paragraph to start listening from there",
    voiceLabel: "Voice",
    voiceDefaultOption: "Default voice",
    narratedWith: "Narrated with",
    audiobooksSectionTitle: "Audiobooks",
  ...
  llm: {
    ...
    playAudio: "Play reply aloud",
    stopAudio: "Stop playback",
    audioLoading: "…",
    micRecord: "Record a voice message",
    micStop: "Stop recording",
    micTranscribing: "Transcribing…",
    ttsTitle: "Text → Audio",
    ttsIntro: "Paste any text and hear it read aloud — same local text-to-speech as the chat's 🔊 button, not tied to a conversation.",
    ttsPlaceholder: "Paste or type text to have it read aloud…",
  ...
  trends: {
    ...
    categoryNews: "News",
    categoryPaper: "Papers",
    categoryRepo: "Repos",
    latestSummaryTitle: "Today's AI Summary",
    modelLabel: "AI model",
    generateSummary: "Generate summary",
    refreshSummary: "Refresh summary",
    generatingSummary: "Thinking…",
    noSummaryYet: "No summary generated yet today — pick a model and generate one from whatever's already been pulled below.",
    insightLabel: "Insight",
    actionItemsLabel: "Action items",
    watchListLabel: "Watch list",
    empty: "No digest yet — the daily fetch runs once a day; check back after it's run at least once.",
    loadFailed: "Couldn't load the trends digest.",
    reload: "The database didn't respond — reload to try again.",
    dbNotConfigured: "Database not connected yet.",
    dbNotConfiguredHint: "Set DATABASE_URL in .env.local to a Neon Postgres connection string, then run the migrations. See SETUP.md.",
  },
  githubTrending: {
    ...
    sectionDevelopers: "Developers",
    starsInPeriodSuffix: "in this window",
    popularRepoPrefix: "Built:",
    snapshotFrom: "Snapshot from",
    empty: "No snapshot yet for this cadence — the fetch runs on its own schedule; check back after it's run at least once.",
    loadFailed: "Couldn't load GitHub Trending.",
    reload: "The database didn't respond — reload to try again.",
    dbNotConfigured: "Database not connected yet.",
    dbNotConfiguredHint: "Set DATABASE_URL in .env.local to a Neon Postgres connection string, then run the migrations. See SETUP.md.",
  },
  diary: {
    ...
    tabWrite: "Write",
    tabPreview: "Preview",
    previewEmpty: "Nothing to preview yet — start writing.",
    wordCount: "words",
    ...
    unsupportedFile: "Unsupported file type",
    docsAttachedHint: "Attached as a file — pull its text into the entry?",
    extractContent: "Extract content",
    extracting: "Extracting…",
    extractFailed: "Couldn't extract text",
    dismiss: "Dismiss",
...
const zh: typeof en = {
  ...
  classroom: {
    ...
    generateAudiobook: "生成有声书",
    regenerateAudiobook: "重新生成有声书",
    generatingAudiobook: "正在朗读文章…",
    audiobookStale: "文章内容在生成有声书后已被修改——请重新生成以保持同步。",
    audioPartOf: "第 {n} 部分，共 {total} 部分",
    audioPrev: "上一段",
    audioNext: "下一段",
    playArticleAudio: "朗读全文",
    pauseAudio: "暂停",
    paragraphOf: "第 {n} 段，共 {total} 段",
    clickHint: "点击高亮段落，从该处开始朗读全文",
    voiceLabel: "语音",
    voiceDefaultOption: "默认语音",
    narratedWith: "朗读音色：",
    audiobooksSectionTitle: "有声书",
  ...
  llm: {
    ...
    micTranscribing: "转录中…",
    ttsTitle: "文本 → 语音",
    ttsIntro: "粘贴任意文本，朗读给你听——与聊天里的 🔊 按钮用的是同一个本地语音合成，不依赖具体的对话内容。",
    ttsPlaceholder: "粘贴或输入要朗读的文本…",
    ttsGenerate: "生成语音",
    ttsGenerating: "生成中…",
    ttsDownload: "下载音频",
    videoComingSoon: "视频（即将推出）",
  },
  trends: {
    title: "趋势",
    description: "每日自动抓取并总结的 AI 新闻、研究论文与热门代码仓库。",
    categoryNews: "新闻",
    categoryPaper: "论文",
    categoryRepo: "代码仓库",
    latestSummaryTitle: "今日 AI 摘要",
    modelLabel: "AI 模型",
    generateSummary: "生成摘要",
    refreshSummary: "刷新摘要",
    generatingSummary: "思考中…",
    noSummaryYet: "今天还没有生成摘要——选择一个模型，根据下方已抓取的内容生成一份。",
    insightLabel: "洞察",
    actionItemsLabel: "可执行事项",
    watchListLabel: "值得关注",
    empty: "还没有每日摘要——抓取任务每天运行一次，运行过后再来看看。",
    loadFailed: "无法加载趋势摘要。",
    reload: "数据库没有响应——请刷新重试。",
    dbNotConfigured: "数据库尚未连接。",
    dbNotConfiguredHint: "在 .env.local 中将 DATABASE_URL 设置为 Neon Postgres 连接字符串，然后运行迁移。详见 SETUP.md。",
  ...
  githubTrending: {
    title: "GitHub 趋势仓库",
    description: "github.com/trending 真实页面的快照——代码仓库与开发者——按三种节奏：每日、每周、每月。",
    tabDaily: "每日",
    tabWeekly: "每周",
    tabMonthly: "每月",
    sectionRepositories: "代码仓库",
    sectionDevelopers: "开发者",
    starsInPeriodSuffix: "（本窗口内）",
    popularRepoPrefix: "代表作：",
    snapshotFrom: "快照时间",
    empty: "该节奏下还没有快照——抓取任务按自己的计划运行，运行过后再来看看。",
    loadFailed: "无法加载 GitHub 趋势仓库。",
    reload: "数据库没有响应——请刷新重试。",
    dbNotConfigured: "数据库尚未连接。",
    dbNotConfiguredHint: "在 .env.local 中将 DATABASE_URL 设置为 Neon Postgres 连接字符串，然后运行迁移。详见 SETUP.md。",
  },
  diary: {
    ...
    imagesOnly: "仅支持图片",
    unsupportedFile: "不支持的文件类型",
    docsAttachedHint: "已作为文件附加——要把文字提取进条目吗？",
    extractContent: "提取内容",
    extracting: "提取中…",
