...
const en = {
  ...
  githubTrending: {
    ...
    description:
      "AI-topic GitHub repos, snapshotted on three cadences — daily, weekly, and monthly — ranked by stars within each window. GitHub has no official trending API, so this approximates it as recently-created repos ranked by stars, same as the Trends tab's repo feed.",
    tabDaily: "Daily",
    tabWeekly: "Weekly",
    tabMonthly: "Monthly",
    groupGeneral: "AI / LLM",
    groupHarnessKnowledge: "Agent Harness & Knowledge",
    stars: "stars",
...
const zh: typeof en = {
  ...
  githubTrending: {
    title: "GitHub 趋势仓库",
    description:
      "按三种节奏（每日、每周、每月）快照的 AI 相关 GitHub 仓库，按各自窗口内的星标数排序。GitHub 没有官方趋势 API，这里用“近期创建 + 星标排序”来近似，与趋势页里代码仓库栏目的思路一致。",
    tabDaily: "每日",
    tabWeekly: "每周",
    tabMonthly: "每月",
    groupGeneral: "AI / LLM",
    groupHarnessKnowledge: "Agent Harness 与知识管理",
    stars: "星标",
    snapshotFrom: "快照时间",
