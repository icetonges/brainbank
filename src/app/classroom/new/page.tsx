...
// actions.ts) — one local-model call (publishAssist), plus a second
// (translateClassroomArticleAction) when the article is published in
// Chinese. Same slow-local-model exposure as the article and edit pages;
// see the maxDuration comment on
