...
// classroom/new/page.tsx) exports `maxDuration` itself (300 as of
// 2026-09-01, reverted from 500 — see that page's comment) — see the
...
// root — it sets the same maxDuration for src/app/classroom/** and
...
// given deploy.
//
// That config was raised to 500 for headroom, then reverted back to 300 on
// 2026-09-01 — 500 requires Fluid Compute enabled on the Vercel project,
// and without it deploys weren't landing at all. See the maxDuration
// comment on classroom/[slug]/page.tsx.
//
